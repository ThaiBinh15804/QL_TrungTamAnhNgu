...
namespace QL_TrungTamAnhNgu.ViewModel
{
    ...
    public class BangDiem
    {
        ...
        public BangDiem(string mahv, string malop, DataClasses1DataContext data)
        {
            ...
            {
                DangKy_BaiTap c = data.DangKy_BaiTaps.FirstOrDefault(t => t.MaBaiTap == item.MaBaiTap && t.DangKy.ThanhToan.MaHocVien == mahv);
